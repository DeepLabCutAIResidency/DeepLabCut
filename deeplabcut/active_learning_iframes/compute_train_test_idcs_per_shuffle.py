...
if __name__ == "__main__":
    ####################################
    ### Input data
    parent_dir_path = '/home/sofia/datasets/Horse10_OOD/Horses-Byron-2019-05-08/labeled-data'
    output_pickle_path = 'out.pkl'
...
#     pickle.dumps([map_shuffle_id_to_train_dirs,
#                   map_shuffle_id_to_test_AL_dirs_w_nfiles,
