"""
To run covering training:
nohup 
    python deeplabcut/data_augm_pipeline_scripts/data_augm_train_all_models.py 
    /media/data/stinkbugs-DLC-2022-07-15_COVERING/config.yaml 
    'stinkbugs-DLC-2022-07-15_COVERING_' 
    1  --train_iteration=1 > log_gpu_1_stinkbug_covering.txt &
